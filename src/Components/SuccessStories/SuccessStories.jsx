                                ...
                                <div className="counter-box-area">
                                    <div className="counter-box wow fadeInUp" data-wow-delay=".5s">
                                        ...
                                        <div className="content">
                                            ...
                                            <p>Delivering high-quality web solutions to satisfied clients worldwide.</p>
                                        </div>
                                    </div>
                                    <div className="counter-box wow fadeInUp" data-wow-delay=".7s">
                                        ...
                                        <div className="content">
                                            ...
                                            <p>Our commitment to quality ensures every client gets exactly what they need.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
