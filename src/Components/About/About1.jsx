...
const About1 = () => {
    ...
    const aboutContent = {
        ...
        subtitle: "About Pixel Web Developers",
        title: 'Building Tomorrow’s Web, Today',
        content: 'At Pixel Web Developers, we are dedicated to transforming your digital vision into reality. Based in Lahore, Pakistan, our team of experts crafts bespoke web solutions that drive growth and engagement. We combine creativity with technical prowess to deliver outstanding results.',
        number1: '98%',
        content2: 'Client <br> Satisfaction',
        number2: '100%',
        content3: 'Project <br> Success Rate',
    }
                        ...
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                <div className="main-button wow fadeInUp" data-wow-delay=".3s">
                                    <a href="#about" className="theme-btn"> EXPLORE MORE <span className="arrow-btn"><i className="bi bi-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
